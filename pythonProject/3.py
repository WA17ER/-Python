...
class Position(Worker):
    def get_full_name(self):
        print(f'Имя сотрудника {self.name}, Фаммилия {self.surname}')

    def get_total_income(self):
        print(f'Доход сотрудника равен {sum(list(self._income.values()))}')

worker1_inc = {"wage": 15000, "bonus": 2000}

worker1 = Position('Иванов','Иван','Менеджер', worker1_inc)
